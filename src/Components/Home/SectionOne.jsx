        ...
        <div className='pt-[150px]   min-h-screen'>
            <div className='absolute w-full'>
                <Container>
                    ...
                    <div>
                        <h1 className='font-bold uppercase text-[14vw] p-0 m-0 leading-none text-[#131313]'>Mark</h1>
                    </div>
                    ...
                    <div className='flex items-start justify-between lg:flex-row flex-col-reverse w-full '>
                        ...
                        <div className=' flex justify-end w-full'>
                            <p className='font-bold uppercase text-[14vw] p-0 m-0  text-[#131313] text-right leading-none lg:-mt-10'>Eting</p>

                        </div>
                    </div>
                </Container>
                
                <div className='relative flex justify-end bottom-20'>
                    <Image className=' -z-10' width={1000} height={500} alt='meeting_image' src={'/images/heroImg.jpg'}></Image>
                </div>
            </div>
        </div>
    );
